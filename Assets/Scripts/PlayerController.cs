...
public class PlayerController : MonoBehaviour
{
    ...
    //Sound Gun Effect
    AudioSource m_shooting;

    // Player Movements, using new input system
    ...
    void Start()
    {
        m_shooting = GetComponent<AudioSource>();
    }
    ...
    private void Awake()
    {
        ...
        //locks cursor for the crosshair
    ...
    //spawns a bullet and shoots at the direction of where the player is aiming at.
    ...
    void Update()
    {
        ...
        //Jumping Mechanism (height differential)
        ...
        //Aiming Mechanism (mouse rotation and direction)
